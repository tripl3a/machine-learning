...
for(iter in 1:niter){
  ...
  window<-max(window*0.999,0.001) # <========== REDUCE THE WINDOW SIZE INCREMENTALLY <==========
...
NN3<-function(param,x1,x2)
{
  ...
  #output layer
  a21 <- inv.logit(a11*wol11 + a12*wol12 + bol1)
  a22 <- inv.logit(a11*wol21 + a12*wol22 + bol2)
  a23 <- inv.logit(a11*wol31 + a12*wol32 + bol3)
